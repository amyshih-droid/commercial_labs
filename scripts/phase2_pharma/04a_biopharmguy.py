"""
BioPharmGuy Directory Scraper 
===========================================================
- Uses curl_cffi for browser impersonation to bypass Cloudflare firewalls.
- Targets specific high-value R&D sub-directories on BioPharmGuy.
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "biopharmguy_therapeutics_rd.csv")
...
TARGET_ENDPOINTS = {
    "Biologics": "/links/company-by-location-biologics.php",
    "RNA, Peptide & Gene Therapy": "/links/company-by-location-dna-rna.php",
    "Antibodies": "/links/company-by-location-antibodies.php",
    "Small Molecules": "/links/company-by-location-small-molecules.php",
    "Stem Cells": "/links/company-by-location-stem-cells.php",
    "Radiopharmaceuticals": "/links/company-by-location-radiopharmaceuticals.php",
    "Tissue Engineering": "/links/company-by-location-tissue-engineering.php",
    "Vaccines": "/links/company-by-location-vaccines.php",
    "Genetics & Genomics" : "/links/company-by-location-genetics.php",
    "Microbiome/Bacteriome" : "/links/company-by-location-microbiome.php",
    "Viral Technology" : "/links/company-by-location-viral-technology.php"
}
...
def scrape_biopharmguy_category(category_name, endpoint):
    ...
    try:
        ...
        if USE_STEALTH:
            ...
            print("  Warning: curl_cffi not detected. Falling back to standard requests...")
...
if __name__ == "__main__":
    print("="*60)
    print("Script 06: BioPharmGuy Advanced Biologics & Gene Therapy Ingestion")
    print("="*60)
    ...
    if master_list:
        ...
        # Deduplicate companies listed under both "Biologics" and "RNA/Gene Therapy"
        df_clean = df.drop_duplicates(subset=["lab_name", "city", "state"], keep="first")
        
        df_clean.to_csv(OUTPUT_FILE, index=False)
        print("\n" + "="*60)
        print(f" HARVEST COMPLETE: Aggregated {len(df_clean)} unique Pure R&D entities!")
