...
def main():
    ...
    parser.add_argument("--source", required=True,
                         help="Name of the source config")
    parser.add_argument("--raw-file", type=Path, default=None,
                         help="Path to raw file (overrides config)")
    parser.add_argument("--out", type=Path, default=None,
                         help="Path to output file (overrides default)")
    parser.add_argument("--source-name", help="Override the source_name defined in the YAML config")
